namespace PokemonTCG.API.DTOs
{
    public class CardDetailDTO
    {
        ...
        public List<AttackDetailDTO> AttackDetails { get; set; }
        public List<AbilityDetailDTO> AbilityDetails { get; set; }
        public List<ResistanceDetailDTO> ResistanceDetails { get; set; }
        public List<WeaknessDetailDTO> WeaknessDetails { get; set; }
